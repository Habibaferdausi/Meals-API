      ...
      <div class="card h-50">
          ...
          <div class="card-body">
             ...
             <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
              <button onclick="loadMealDetail2(${meal.idMeal})"  type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#mealDetails">
                  Details
              </button>
          </div>
...
const displayMealDetails = (meal) => {
  ...
  mealsDetails.innerHTML = `
      <img class="h-20 w-75" src="${meal.strMealThumb}"> `;
